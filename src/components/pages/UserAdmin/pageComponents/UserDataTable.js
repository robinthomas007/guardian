...
class UserDataTable extends Component {
    ...
    handleTableSort = (columnID) => {
        ...
        if(this.state.sortColumnID === columnID && this.state.sortColumnOrder === 'asc') {
            this.setState( {sortColumnID : columnID, sortColumnOrder : 'desc'}, () =>  this.props.handleColumnSort(columnID, 'desc', this.props.pageView))
         } else if (this.state.sortColumnID === columnID && this.state.sortColumnOrder === 'desc') {   
             this.setState( {sortColumnID : columnID, sortColumnOrder : 'asc'}, () =>  this.props.handleColumnSort(columnID, 'asc', this.props.pageView))
        } else {
            this.setState( {sortColumnID : columnID}, () =>  this.props.handleColumnSort(columnID, defaultSortOrder, this.props.pageView))
        }
    };
        ...
        return(
            <td className="text-center">
                {this.props.pageView === 'requesting' ? (
                    ...
                    <>
                        <Button onClick={() => this.props.showUserEditModal(user)} className={'btn btn-primary'}>
                ...
                <thead>
                    <tr className="d-flex w-100">
                        ...
                        >
                            ...
                            <i
                                className={
                                    this.state.activeHover === 'date_created' || this.state.sortColumnID === 'date_created'
                                        ? 'material-icons'
                        ...
                        >
                            ...
                            <i
                                className={
                                    this.state.activeHover === 'first_name' || this.state.sortColumnID === 'first_name'
                                    ? 'material-icons' 
                                    : 'material-icons d-none'
                                }
                            >
