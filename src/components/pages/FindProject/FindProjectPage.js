...
class FindProjectPage extends Component {
  ...
  handleChange(event) {
    this.setState({
      searchCriteria: { ...this.state.searchCriteria, searchTerm: event.target.value },
    });
  }
  ...
  setProjectsView(count) {
    this.setState(
      currentState => ({ searchCriteria: { ...this.state.searchCriteria, itemsPerPage: count } }),
      () => {
        this.handleProjectSearch();
      },
    );
  ...
  handlePaginationChange(newPage) {
    this.setState(
      currentState => ({ searchCriteria: { ...this.state.searchCriteria, pageNumber: newPage } }),
      () => {
        this.handleProjectSearch();
      },
    );
  ...
  handleColumnSort = (columnID, columnSortOrder) => {
    ...
    this.setState({ searchCriteria: modifiedSearchCriteria }, () => {
      this.handleProjectSearch();
    });
  };
